...
* `git clone git@github.com:rumblex/angularattack2016-ng-warrior.git`

* `cd angularattack2016-ng-warrior`
...
If receive the error message `"You do not have permission to publish to ng-warrior.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add tanjilahsan@gmail.com,afrozaewu10@hotmail.com,bilashcse@gmail.com,zahirul.arb@gmail.com`
